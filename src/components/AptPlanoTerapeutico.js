...
function AptPlanoTerapeutico() {
    ...
    return (
      <div id="AVALIAÇÃO DE DECLÍNIO FUNCIONAL - ADF">
        ...
        <div id="ADF - opções" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', padding: 5, marginTop: 0 }}>
          <button style={{ width: '9vw', height: 90, opacity: adf == 1 ? 1 : 0.3 }} className="green-button" onClick={() => setadf(1)}>
            AUSENTE
          </button>
    ...
    return (
      <div id="CLASSIFICAÇÃO DE RISCO FUNCIONAL - CRF">
        ...
        <div id="CRF - opções" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', padding: 5, marginTop: 0 }}>
          <button style={{ width: '9vw', height: 90, opacity: crf == 1 ? 1 : 0.3 }} className="green-button" onClick={() => setcrf(1)}>
            PACIENTE ROBUSTO
          </button>
  ...
  return (
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', width: '80vw' }}>
        <Regua></Regua>
