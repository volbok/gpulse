...
function AptEscalaPPS({ viewescalapps }) {
  ...
  function Deambulacao() {
    return (
      <div id="DEAMBULAÇÃO">
        <button className="green-button" style={{ width: '50vw', opacity: deambulacao == 1 ? 1 : 0.5 }} onClick={() => setdeambulacao(1)}>
          COMPLETA
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: deambulacao == 2 ? 1 : 0.5 }} onClick={() => setdeambulacao(2)}>
          REDUZIDA
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: deambulacao == 3 ? 1 : 0.5 }} onClick={() => setdeambulacao(3)}>
          SENTADO OU DEITADO
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: deambulacao == 4 ? 1 : 0.5 }} onClick={() => setdeambulacao(4)}>
          ACAMADO
        </button>
      </div>
    )
  ...
  function AtividadeEvidenciaDaDoenca() {
    return (
      <div id="ATIVIDADE E EVIDÊNCIA DA DOENÇA">
        <button className="green-button" style={{ width: '50vw', opacity: atividade == 1 ? 1 : 0.5 }} onClick={() => setatividade(1)}>
          NORMAL. SEM EVIDÊNCIA DE DOENÇA
        </button>
        <button className="green-button" style={{ width: '50vw', opacity: atividade == 2 ? 1 : 0.5 }} onClick={() => setatividade(2)}>
          NORMAL. ALGUMA EVIDÊNCIA DE DOENÇA
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: atividade == 3 ? 1 : 0.5 }} onClick={() => setatividade(3)}>
          COM ESFORÇO. ALGUMA EVIDÊNCIA DE DOENÇA
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: atividade == 4 ? 1 : 0.5 }} onClick={() => setatividade(4)}>
          INCAPAZ PARA O TRABALHO. ALGUMA EVIDÊNCIA DE DOENÇA
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: atividade == 5 ? 1 : 0.5 }} onClick={() => setatividade(5)}>
          INCAPAZ DE REALIZAR HOBBIES. DOENÇA SIGNIFICATIVA
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: atividade == 6 ? 1 : 0.5 }} onClick={() => setatividade(6)}>
  ...
  function AutoCuidado() {
    return (
      <div id="AUTOCUIDADO">
        <button className="green-button" style={{ width: '50vw', opacity: autocuidado == 1 ? 1 : 0.5 }} onClick={() => setautocuidado(1)}>
          COMPLETO
        </button>
        <button className="green-button" style={{ width: '50vw', opacity: autocuidado == 2 ? 1 : 0.5 }} onClick={() => setautocuidado(2)}>
          ASSISTÊNCIA OCASIONAL
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: autocuidado == 3 ? 1 : 0.5 }} onClick={() => setautocuidado(3)}>
          ASSISTÊNCIA CONSIDERÁVEL
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: autocuidado == 4 ? 1 : 0.5 }} onClick={() => setautocuidado(4)}>
          ASSISTÊNCIA QUASE COMPLETA
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: autocuidado == 5 ? 1 : 0.5 }} onClick={() => setautocuidado(5)}>
  ...
  function Ingestao() {
    return (
      <div id="INGESTÃO">
        <button className="green-button" style={{ width: '50vw', opacity: ingestao == 1 ? 1 : 0.5 }} onClick={() => setingestao(1)}>
          NORMAL
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: ingestao == 2 ? 1 : 0.5 }} onClick={() => setingestao(2)}>
          REDUZIDA
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: ingestao == 3 ? 1 : 0.5 }} onClick={() => setingestao(3)}>
          INGESTÃO LIMITADA A COLHERADAS
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: ingestao == 4 ? 1 : 0.5 }} onClick={() => setingestao(4)}>
          CUIDADOS COM A BOCA
        </button>
      </div>
    )
  ...
  function NivelDeConsciencia() {
    return (
      <div id="NÍVEL DE CONSCIÊNCIA">
        <button className="green-button" style={{ width: '50vw', opacity: niveldeconsciencia == 1 ? 1 : 0.5 }} onClick={() => setniveldeconsciencia(1)}>
          COMPLETA
        </button>
        <button className="yellow-button" style={{ width: '50vw', opacity: niveldeconsciencia == 2 ? 1 : 0.5 }} onClick={() => setniveldeconsciencia(2)}>
          PERÍODOS DE CONFUSÃO
        </button>
        <button className="red-button" style={{ width: '50vw', opacity: niveldeconsciencia == 3 ? 1 : 0.5 }} onClick={() => setniveldeconsciencia(3)}>
          CONFUSO OU EM COMA
        </button>
      </div>
    )
